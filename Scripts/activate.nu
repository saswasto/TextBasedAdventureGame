...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\saswa\PycharmProjects\pythonProject4\textGame'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\saswa\PycharmProjects\pythonProject4\textGame\Scripts\deactivate.nu'
